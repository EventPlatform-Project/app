...
/**
 * Feign configuration for ms-reservation.
 * <p>
 * Forwards the incoming request's {@code Authorization} header onto every
 * outgoing Feign call. Required because ms-event (reached via the API gateway)
 * enforces JWT authentication on {@code /api/events/**}.
 */
@Configuration
