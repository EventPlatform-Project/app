...
public class SecurityConfig {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html",
                                         "/api/feedback/v3/api-docs/**").permitAll()
    ...
    /**
     * Converts a Keycloak JWT into a Spring Security Authentication whose
     * authorities include realm-role and resource-role grants prefixed with
     * {@code ROLE_}. Kept private (not a {@code @Bean}) to avoid
     * mvcConversionService complaints.
     */
